...
`AGENTS.md` (project root) mirrors this file for non-Claude AI agents. When updating CLAUDE.md with decisions that affect project direction, apply the same change to AGENTS.md.
